...
urlpatterns = [
    ...
    path('registration/personal-details', views.personalformview, name="personal details"),
    path('registration/pension-details', views.pensionformview, name="pension details"),
    path('registration/employment-details', views.employmentformview, name='employment details'),

# Generated by Django 3.1.5 on 2021-03-08 06:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emp_status', models.CharField(choices=[('', '---------'), ('E', 'Employed'), ('U', 'UnEmployed')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('mobile', models.CharField(max_length=10)),
                ('basic_reg_type', models.CharField(choices=[('', '---------'), ('S', ' SELF'), ('W', 'WIDOW')], default=None, max_length=1)),
                ('have_esm', models.CharField(blank=True, choices=[('', '---------'), ('Y', 'Yes'), ('N', 'No')], default=None, max_length=1, null=True)),
                ...
                ('discharge_book', models.ImageField(blank=True, null=True, upload_to='images/discharge book')),

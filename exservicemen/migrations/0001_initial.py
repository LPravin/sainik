# Generated by Django 3.1.5 on 2021-03-19 16:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('basic_reg_type', models.CharField(choices=[('', '---------'), ('E', 'ESM'), ('W', 'Widow of already registered ESM'), ('TE', 'Transferred ESM/Widow'), ('UW', 'Widow of Unregistered/Died in service')], max_length=2)),
                ...
                ('ppo_book', models.ImageField(blank=True, null=True, upload_to='images/ppo book', verbose_name='PPO BOOK')),

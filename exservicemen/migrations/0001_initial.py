# Generated by Django 3.1.5 on 2021-04-20 12:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('primary_key', models.SmallIntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ref', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='exservicemen.exservicemen')),
                ('specialization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='exservicemen.specialization')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rank_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='exservicemen.rankcategory')),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='exservicemen.service')),
            ],
        ),
        migrations.CreateModel(
            name='ServiceDetail',
            fields=[
                ...
                ('corps', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='exservicemen.corp')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='exservicemen.tradegroup')),
                ('prefix', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='exservicemen.servicenoprefix')),
                ('rank', models.ForeignKey(default=None, on_delete=django.db.models.deletion.DO_NOTHING, to='exservicemen.rank')),
                ('rank_category', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='exservicemen.rankcategory')),
                ('record_office', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='exservicemen.recordoffice')),
                ('ref', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='exservicemen.exservicemen')),
                ('reg_type', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='exservicemen.esmtype')),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='exservicemen.service')),
                ('suffix', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='exservicemen.servicenosuffix')),
                ('trade', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='exservicemen.trade')),
            ],
        ),
        migrations.CreateModel(
            name='RSBOfficer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ppo_no', models.CharField(blank=True, max_length=16, verbose_name='PPO No')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('civil_qualification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='exservicemen.civilqualification')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dep_qualification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='exservicemen.civilqualification', verbose_name='Dependent Qualification')),
